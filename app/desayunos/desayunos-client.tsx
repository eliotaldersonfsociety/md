...
interface DesayunosClientProps {
  city?: City
}
...
export default function DesayunosClient({ city }: DesayunosClientProps) {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para un desayuno sorpresa en ${locationText}. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Desayunos Sorpresa en <span className="text-pink-300">{city ? city.name : 'Colombia y Venezuela'}</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Los desayunos mas especiales para sorprender a esa persona que quieres en {locationText}. Calidad y amor en cada detalle.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Desayunos Sorpresa en {city ? city.name : 'Colombia y Venezuela'}
            </h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Ideas para tu Desayuno Sorpresa en {city ? city.name : 'Colombia y Venezuela'}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Desayunos romanticos con peluches y cojines para sorprender a tu persona especial en {locationText}.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Desayunos inolvidables con peluches personalizados y detalles unicos en {locationText}.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Desayunos corporativos y regalos personalizados para tus colaboradores en {locationText}.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Listo para armar tu desayuno sorpresa en {city ? city.name : 'Colombia y Venezuela'}?
          </h2>
