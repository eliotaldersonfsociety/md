...
import { MapPin, Truck, Gift, Sparkles, MessageCircle, Star, ArrowRight, Coffee } from "lucide-react"
...
interface DesayunosCityClientProps {
  city: City
}

const breakfastProducts = allProducts
  .filter(p => p.category === "peluches" || p.category === "cojines" || p.category === "latas" || p.category === "llaveros")
  .slice(0, 8)

export default function DesayunosCityClient({ city }: DesayunosCityClientProps) {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para un desayuno sorpresa en ${city.name}, ${departmentText}, ${countryText}. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/20 text-white text-sm font-medium mb-6 backdrop-blur-sm">
            ✨ Desayunos Sorpresa en {city.name}
          </span>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Desayunos Sorpresa en <span className="text-pink-300">{city.name}</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Los desayunos mas especiales para sorprender a esa persona que quieres en {city.name}, {departmentText}, {countryText}. Calidad y amor en cada detalle.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="rounded-full px-8 bg-white text-primary hover:bg-white/90 font-semibold">
              <Link href="#productos">Ver Desayunos <ArrowRight className="ml-2 h-5 w-5" /></Link>
            </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Los desayunos mas queridos para cumpleanos, aniversarios y toda ocasion especial.
            </p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Ideas para tu Desayuno Sorpresa en {city.name}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Desayunos romanticos con peluches y cojines para sorprender a tu persona especial en {city.name}.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Desayunos inolvidables con peluches personalizados y detalles unicos en {city.name}.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Desayunos corporativos y regalos personalizados para tus colaboradores en {city.name}.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Listo para armar tu desayuno sorpresa en {city.name}?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Envios a {city.name} y toda la region. Personaliza tu regalo y haz de cualquier fecha un momento inolvidable.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="rounded-full px-8 bg-white text-primary hover:bg-white/90 font-semibold">
              <Link href="/contacto">
            ...
            <Button
              ...
              onClick={() => openWhatsApp(`Desayuno sorpresa ${city.name}`)}
            >
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                question: "¿Que incluyen los desayunos sorpresa?",
                answer: "Nuestros desayunos sorpresa incluyen peluches, cojines, latas y otros detalles personalizados. Se pueden combinar con opciones de desayuno clasico o gourmet."
              },
              {
                question: "¿Puedo personalizar el desayuno?",
                answer: "Si, todos nuestros desayunos se pueden personalizar con nombres, fechas, mensajes o logos. Contamos con disenos listos o creamos uno exclusivo."
              },
              {
                question: `¿Hacen envios a ${city.name}?`,
                answer: `Si, realizamos envios a ${city.name} y toda la region de ${departmentText}. El envio es gratis a partir de $500.000 pesos.`
              },
              {
