...
interface SorpresasCityClientProps {
  city: City
}

const surpriseProducts = allProducts
  .filter(p => p.category === "peluches" || p.category === "cojines" || p.category === "llaveros" || p.category === "latas")
  .slice(0, 8)

export default function SorpresasCityClient({ city }: SorpresasCityClientProps) {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para una sorpresa en ${city.name}, ${departmentText}, ${countryText}. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/20 text-white text-sm font-medium mb-6 backdrop-blur-sm">
            ✨ Sorpresas en {city.name}
          </span>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Sorpresas en <span className="text-pink-300">{city.name}</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Encuentra los mejores regalos y detalles para sorprender a esa persona especial en {city.name}, {departmentText}, {countryText}. Envios rapidos y calidad garantizada.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="rounded-full px-8 bg-white text-primary hover:bg-white/90 font-semibold">
              <Link href="#productos">Ver Sorpresas <ArrowRight className="ml-2 h-5 w-5" /></Link>
            </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Sorpresas y Regalos en {city.name}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Los regalos mas queridos para cumpleanos, aniversarios y toda ocasion especial.
            </p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Ideas para tu Sorpresa en {city.name}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Regalos romanticos y sorpresas inolvidables para acompanar a tu persona especial en {city.name}.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches personalizados y detalles unicos para cumpleanos inolvidables en {city.name}.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Listo para armar tu sorpresa en {city.name}?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              onClick={() => openWhatsApp(`Sorpresa ${city.name}`)}
            >
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                question: "¿Que productos incluyen las sorpresas?",
                answer: "Nuestras sorpresas incluyen peluches, cojines, llaveros y latas personalizadas. Todos se pueden combinar y personalizar con nombres, fechas o mensajes."
              },
              {
                question: "¿Puedo personalizar la sorpresa?",
