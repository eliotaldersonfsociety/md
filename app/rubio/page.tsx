...
export const metadata: Metadata = {
  title: "Peluches en Rubio | Fábrica de Peluches Mundo Disney",
  description: "Fábrica de peluches y regalos personalizados en Rubio, Táchira, Venezuela. Cojines, cervicales, llaveros y más. Envíos locales y nacionales.",
  canonical: "/rubio",
}

export default function RubioPage() {
  return (
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4">
          <div className="text-center text-primary-foreground">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              Peluches y Regalos en <span className="text-yellow-300">Rubio</span>
            </h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto text-primary-foreground/90">
              Fábrica de peluches, cojines, cervicales y regalos personalizados. Envíos a Rubio y todo el estado Táchira.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-border text-center">
              ...
              <h3 className="font-semibold text-foreground mb-2">Envíos en Rubio</h3>
              <p className="text-muted-foreground text-sm">Entrega en 3-5 días hábiles en Rubio y alrededores.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-border text-center">
              <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-muted-foreground text-sm">Regalos para cumpleaños, aniversarios y eventos.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-border text-center">
              <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="bg-muted/30 rounded-2xl p-8 mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6 text-center">
              Productos Disponibles para Envío en Rubio
            </h2>
          ...
          <div className="bg-gradient-to-r from-primary to-pink-400 rounded-2xl p-8 text-center text-white">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">¿Pedir por WhatsApp desde Rubio?</h2>
