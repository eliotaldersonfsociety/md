...
const regalosProducts = allProducts
...
export default function RegalosClient() {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para regalar. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Regalos <span className="text-pink-300">Personalizados</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Peluches, cojines, llaveros y detalles únicos para regalar en cualquier fecha. Envíos a Colombia y Venezuela.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Los peluches, cojines y detalles más queridos para regalar en cualquier fecha especial.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {regalosProducts.map((product) => {
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Regalos para cada momento especial
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Encuentra el regalo perfecto para cada ocasión y cada persona.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches personalizados, cojines con frases especiales y detalles únicos para cumpleaños inolvidables.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches con logo, material POP y regalos corporativos para clientes, colaboradores y eventos.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Listo para regalar algo único?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Envíos a todo Colombia y Venezuela. Personaliza tu regalo y haz de cualquier fecha un momento inolvidable.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="rounded-full px-8 bg-white text-primary hover:bg-white/90 font-semibold">
              <Link href="/contacto">
            ...
            <Button
              ...
              onClick={() => openWhatsApp("Cotización regalo personalizado")}
            >
            ...
            {[
              {
                ...
                answer: "Ofrecemos personalización de nombres, fechas, frases, logos empresariales y diseños especiales en peluches, cojines, llaveros y latas."
              },
              {
                question: "¿Cuánto tiempo tarda un pedido personalizado?",
                answer: "El tiempo estimado es de 5 a 10 días hábiles, dependiendo de la cantidad y la complejidad de la personalización."
              },
              {
                question: "¿Hacen envíos a todo Colombia y Venezuela?",
                answer: "Sí, realizamos envíos a todas las ciudades y municipios. El envío es gratis a partir de $500.000 pesos."
              },
              {
