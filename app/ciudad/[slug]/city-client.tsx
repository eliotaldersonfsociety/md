...
const cityProducts = allProducts
  .filter(p => p.category === "peluches" || p.category === "cojines" || p.category === "llaveros")
  .slice(0, 8)

export default function CityClient({ city }: CityClientProps) {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para envío a ${city.name}, ${departmentText}, ${countryText}. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Peluches y Regalos en <span className="text-pink-300">{city.name}</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Los mejores peluches personalizados, cojines y regalos únicos en {city.name}, {departmentText}, {countryText}. Envíos rápidos y seguros.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Regalos para {city.name}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Los peluches, cojines y detalles más queridos para regalar en {city.name}.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Envío rápido y seguro a {city.name} y toda la región de {departmentText}, {countryText}.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-6 border border-border text-center">
              ...
              <h3 className="font-semibold text-foreground mb-2">Envío a {city.name}</h3>
              <p className="text-sm text-muted-foreground">Entrega rápida y segura</p>
            </div>
            <div className="bg-white rounded-2xl p-6 border border-border text-center">
              <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-4">
                <MapPin className="w-6 h-6 text-primary" />
              </div>
              <h3 className="font-semibold text-foreground mb-2">Cobertura Local</h3>
              <p className="text-sm text-muted-foreground">Toda la región</p>
            </div>
            <div className="bg-white rounded-2xl p-6 border border-border text-center">
              <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Ideas de regalos en {city.name}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Encuentra el regalo perfecto para cualquier ocasión en {city.name}.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches románticos y cojines con mensajes de amor para sorprender a esa persona especial en {city.name}.
              </p>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Listo para regalar en {city.name}?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              onClick={() => openWhatsApp(`Cotización ${city.name}`)}
            >
