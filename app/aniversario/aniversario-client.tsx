...
const aniversarioProducts = allProducts
...
export default function AniversarioClient() {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para un aniversario. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/20 text-white text-sm font-medium mb-6 backdrop-blur-sm">✨ Celebra tu amor</span>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Regalos para <span className="text-pink-300">Aniversario</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">Peluches personalizados y regalos románticos para celebrar tu relación. Envíos a Colombia y Venezuela.</p>
      ...
      <section id="productos" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Regalos Románticos para Aniversario</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">Los peluches y cojines más románticos para celebrar tu aniversario.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {aniversarioProducts.map((product) => {
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium mb-4">Ideas Románticas</span>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Ideas de Regalos para Aniversario</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">Inspírate con nuestras ideas para celebrar tu amor.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">Agrega nombres, fechas o mensajes especiales. Un regalo único y memorable.</p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">Mensajes de amor en cojines suaves y personalizados. Perfectos para decorar.</p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">Combina peluches con flores y detalles para crear el regalo perfecto.</p>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">¿Listo para celebrar tu aniversario?</h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Contáctanos ahora y te ayudamos a crear el regalo perfecto para celebrar tu amor.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="rounded-full px-8 border-white/30 text-white hover:bg-white/10 font-semibold" onClick={() => openWhatsApp("Cotización Aniversario")}><MessageCircle className="mr-2 h-5 w-5" /> WhatsApp</Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { question: "¿Cuándo debo hacer mi pedido para un aniversario?", answer: "Te recomendamos hacer tu pedido con al menos 5 días hábiles de anticipación para garantizar la entrega a tiempo." },
              { question: "¿Puedo personalizar el regalo con una fecha especial?", answer: "Sí, todos nuestros peluches y cojines se pueden personalizar con fechas, nombres o mensajes especiales." },
              { question: "¿Qué regalo es más popular para aniversario?", answer: "Los cojines con mensajes de amor y los peluches personalizados son los más elegidos para esta fecha." },
