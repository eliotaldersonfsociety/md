...
interface ArreglosFloralesCityClientProps {
  city: City
}

const floralProducts = allProducts
  .filter(p => p.category === "peluches" || p.category === "cojines" || p.category === "llaveros" || p.category === "latas")
  .slice(0, 8)

export default function ArreglosFloralesCityClient({ city }: ArreglosFloralesCityClientProps) {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para agregar a un arreglo floral en ${city.name}, ${departmentText}, ${countryText}. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/20 text-white text-sm font-medium mb-6 backdrop-blur-sm">
            ✨ Complementos para Flores en {city.name}
          </span>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Complementos para <span className="text-pink-300">Arreglos Florales</span> en {city.name}
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Peluches, cojines y regalos únicos para complementar tus arreglos florales en {city.name}, {departmentText}, {countryText}.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium mb-4">
              Productos para Flores
            </span>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Regalos para Complementar Flores en {city.name}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Los peluches, cojines y detalles más queridos para agregar a tus arreglos florales.
            </p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Ideas para Complementar tus Flores en {city.name}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Encuentra el complemento perfecto para tu arreglo floral.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches románticos y cojines con mensajes de amor para acompañar tu ramo de flores en {city.name}.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Para cumpleaños</h3>
              <p className="text-muted-foreground mb-4">
                Peluches personalizados y cojines con frases especiales para cumpleaños inolvidables en {city.name}.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches con logo y regalos corporativos para clientes y colaboradores en {city.name}.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Listo para complementar tu arreglo floral en {city.name}?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Envíos a {city.name} y toda la región. Personaliza tu regalo y haz de cualquier fecha un momento inolvidable.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="rounded-full px-8 bg-white text-primary hover:bg-white/90 font-semibold">
              <Link href="/contacto">
            ...
            <Button
              ...
              onClick={() => openWhatsApp(`Complemento para arreglo floral ${city.name}`)}
            >
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                question: "¿Qué productos puedo agregar a un arreglo floral?",
                answer: "Ofrecemos peluches, cojines, llaveros y latas personalizadas que combinan perfectamente con flores. Todos se pueden personalizar con nombres, fechas o mensajes."
              },
              {
                question: "¿Puedo personalizar el regalo con un mensaje?",
              ...
              {
                question: `¿Hacen envíos a ${city.name}?`,
                answer: `Sí, realizamos envíos a ${city.name} y toda la región de ${departmentText}. El envío es gratis a partir de $500.000 pesos.`
              },
              {
                question: "¿Cuánto tiempo tarda la entrega?",
                answer: "El tiempo estimado es de 2 a 5 días hábiles, dependiendo de la ciudad y la transportadora."
              },
              {
