...
interface ArreglosFloralesClientProps {
  city?: City
}
...
export default function ArreglosFloralesClient({ city }: ArreglosFloralesClientProps) {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para agregar a un arreglo floral en ${locationText}. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Complementos para <span className="text-pink-300">Arreglos Florales</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Peluches, cojines y regalos únicos para complementar tus arreglos florales en {locationText}. Ideas originales para regalar junto a flores.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Regalos para Complementar Flores
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Los peluches, cojines y detalles más queridos para agregar a tus arreglos florales en {locationText}.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Ideas para Complementar tus Flores
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Encuentra el complemento perfecto para tu arreglo floral en {locationText}.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches románticos y cojines con mensajes de amor para acompañar tu ramo de flores.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches personalizados y cojines con frases especiales para cumpleaños inolvidables.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <p className="text-muted-foreground mb-4">
                Peluches con logo y regalos corporativos para clientes y colaboradores.
              </p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90">
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Listo para complementar tu arreglo floral?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Envíos a {locationText}. Personaliza tu regalo y haz de cualquier fecha un momento inolvidable.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="rounded-full px-8 bg-white text-primary hover:bg-white/90 font-semibold">
              <Link href="/contacto">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              },
              {
                ...
                answer: city 
                  ? `Sí, realizamos envíos a ${city.name} y toda la región de ${departmentText}. El envío es gratis a partir de $500.000 pesos.`
                  : "Sí, realizamos envíos a todas las ciudades de Colombia y Venezuela. El envío es gratis a partir de $500.000 pesos."
              },
              {
