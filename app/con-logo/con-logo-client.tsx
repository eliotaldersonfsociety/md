...
import { Sparkles, Gift, Truck, MessageCircle, Star, ArrowRight } from "lucide-react"
import { allProducts } from "@/lib/products-data"
import { useState } from "react"
import { buildProductSlug } from "@/lib/slugify"
import { WhatsAppModal } from "@/components/whatsapp-modal"

const logoProducts = allProducts
  .filter(p => p.category === "peluches" || p.category === "llaveros")
  .slice(0, 8)

export default function ConLogoClient() {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" con logo personalizado para mi empresa. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Peluches con <span className="text-pink-300">Logo Personalizado</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Mascotas corporativas, material POP y regalos de marca para tu empresa. Pedidos desde 100 unidades. Envíos a Colombia y Venezuela.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Peluches y Regalos con Logo
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Productos personalizados con el logo de tu empresa. Ideales para campañas, eventos y regalos corporativos.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="p-4">
                    <span className="text-xs text-primary font-medium uppercase tracking-wide">
                      {product.category === "peluches" ? "Peluche" : "Llavero"}
                    </span>
          ...
          <div className="text-center mt-12">
            <Button asChild size="lg" className="rounded-full px-8 bg-primary hover:bg-primary/90">
              <Link href="/empresas">
                Ver Todos los Productos Empresariales <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </div>
        </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              ¿Por qué elegir peluches con logo?
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Los peluches con logo son una herramienta de marketing poderosa y emotiva.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Alto Impacto</h3>
              <p className="text-muted-foreground mb-4">
                Un peluche con logo genera una conexión emocional con tu marca que otros productos no logran.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Regalo Corporativo</h3>
              <p className="text-muted-foreground mb-4">
                Perfecto para clientes, colaboradores y eventos. Un regalo que se recuerda y se valora.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Pedidos desde 100 uds</h3>
              <p className="text-muted-foreground mb-4">
                Trabajamos con pedidos mínimos accesibles. Calidad garantizada y entrega a tiempo.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ¿Listo para crear tu peluche con logo?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Contáctanos ahora y te ayudamos a crear el regalo corporativo perfecto para tu empresa.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="rounded-full px-8 bg-white text-primary hover:bg-white/90 font-semibold">
              <Link href="/contacto">
            ...
            <Button
              ...
              onClick={() => openWhatsApp("Cotización peluche con logo")}
            >
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              {
                question: "¿Cuál es el pedido mínimo para peluches con logo?",
                answer: "El pedido mínimo es de 100 unidades para peluches personalizados con logo. Contáctanos para proyectos especiales."
              },
              {
                question: "¿Puedo ver un diseño previo antes de producir?",
                answer: "Sí, realizamos una maqueta digital para que apruebes el diseño antes de iniciar la producción."
              },
              {
                question: "¿Qué tipos de logo admiten?",
                answer: "Aceptamos logos en formato vectorial (AI, EPS, SVG) o en alta resolución (PNG, JPG). Te ayudamos a adaptar tu marca."
              },
              {
                question: "¿Hacen envíos a toda Colombia y Venezuela?",
                answer: "Sí, realizamos envíos nacionales e internacionales. El envío es gratis a partir de $500.000 pesos."
              },
              {
                question: "¿Cuánto tiempo tarda la producción?",
                answer: "El tiempo estimado es de 10 a 15 días hábiles, dependiendo de la cantidad y la complejidad del diseño."
              }
            ].map((faq, index) => (
              <details
                key={index}
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            ...
            <Link href="/llaveros" className="bg-white rounded-xl p-6 text-center border border-border hover:border-primary/20 transition-colors">
              <Truck className="h-8 w-8 text-primary mx-auto mb-3" />
              <h3 className="font-semibold text-foreground">Llaveros</h3>
              <p className="text-sm text-muted-foreground">Ver todos</p>
            </Link>
          </div>
        </div>
