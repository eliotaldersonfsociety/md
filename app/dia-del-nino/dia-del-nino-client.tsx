...
const ninoProducts = allProducts
  .filter(p => p.category === "peluches")
  .slice(0, 8)

export default function DiaDelNinoClient() {
  ...
  const openWhatsApp = (productName: string) => {
    setWhatsAppMessage(
      encodeURIComponent(
        `Hola, me interesa el producto "${productName}" para el Día del Niño. ¿Tienen disponibilidad y cuál es el tiempo de entrega?`
      )
    )
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20 max-w-4xl mx-auto">
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/20 text-white text-sm font-medium mb-6 backdrop-blur-sm">✨ Último Domingo de Julio</span>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance leading-tight">
            Regalos para el <span className="text-pink-300">Día del Niño</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">Los peluches más divertidos y tiernos para sorprender a los niños. Envíos a Colombia y Venezuela.</p>
      ...
      <section id="productos" className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Peluches para el Día del Niño</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">Los peluches más queridos para regalar a los niños.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ninoProducts.map((product) => {
              ...
              return (
                <div key={product.id} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border">
                  ...
                  <div className="p-4">
                    <span className="text-xs text-primary font-medium uppercase tracking-wide">Peluche</span>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium mb-4">Ideas por edad</span>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Regalos para cada edad</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">Tenemos opciones para niños de todas las edades.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors text-center">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Bebés</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors text-center">
              <div className="text-4xl mb-4">🧒</div>
              <h3 className="text-xl font-bold text-foreground mb-3">Niños pequeños</h3>
              <p className="text-muted-foreground mb-4">Peluches divertidos y educativos para que jueguen y aprendan.</p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90"><Link href="/peluches">Ver opciones <ArrowRight className="ml-2 h-4 w-4" /></Link></Button>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-border hover:border-primary/20 transition-colors text-center">
              <div className="text-4xl mb-4">👦</div>
              <h3 className="text-xl font-bold text-foreground mb-3">Niños grandes</h3>
              <p className="text-muted-foreground mb-4">Peluches coleccionables y personalizados para todas las edades.</p>
              <Button asChild className="w-full rounded-full bg-primary hover:bg-primary/90"><Link href="/peluches">Ver opciones <ArrowRight className="ml-2 h-4 w-4" /></Link></Button>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-br from-primary to-primary/80 rounded-3xl p-8 md:p-12 text-primary-foreground text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">¿Listo para celebrar el Día del Niño?</h2>
            <p className="text-primary-foreground/90 mb-8 max-w-2xl mx-auto text-lg">Envíos a todo Colombia y Venezuela. Haz de este día una fecha inolvidable.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="rounded-full px-8 border-white/30 text-white hover:bg-white/10 font-semibold" onClick={() => openWhatsApp("Cotización Día del Niño")}><MessageCircle className="mr-2 h-5 w-5" /> WhatsApp</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { question: "¿Cuándo debo hacer mi pedido para el Día del Niño?", answer: "Te recomendamos hacer tu pedido con al menos 5 días hábiles de anticipación para garantizar la entrega a tiempo." },
              { question: "¿Puedo personalizar el peluche con el nombre del niño?", answer: "Sí, todos nuestros peluches se pueden personalizar con nombres, fechas o mensajes especiales." },
              { question: "¿Qué peluche es más popular para el Día del Niño?", answer: "Los peluches de animales y los personajes animados son los más elegidos para esta fecha." },
