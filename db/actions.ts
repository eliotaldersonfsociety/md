...
export async function seedProductsAndVariants(): Promise<void> {
  ...
  const allProducts = [
    ...
    // Peluches
    { id: 101, name: "Peluche Milo Gato", price: 60000, originalPrice: 55000, image: "/images/peluches/1.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 60000 }, { label: "#3 - 60cm", price: 120000 }, { label: "#4 - 100cm", price: 150000 }], stock: 15 },
    { id: 102, name: "Peluche Mimi Gata", price: 60000, originalPrice: 72000, image: "/images/peluches/2.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 60000 }, { label: "#3 - 60cm", price: 120000 }, { label: "#4 - 100cm", price: 150000 }], stock: 25 },
    { id: 103, name: "Peluche Bubu Mono", price: 68000, originalPrice: 85000, image: "/images/peluches/3.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 48000 }, { label: "#3 - 60cm", price: 68000 }, { label: "#4 - 100cm", price: 88000 }], stock: 18 },
    { id: 104, name: "Peluche Lala Mona", price: 55000, image: "/images/peluches/4.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 40000 }, { label: "#3 - 60cm", price: 55000 }, { label: "#4 - 100cm", price: 75000 }], stock: 22 },
    { id: 105, name: "Peluche Dodo Conejo", price: 48000, image: "/images/peluches/5.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 36000 }, { label: "#3 - 60cm", price: 48000 }, { label: "#4 - 100cm", price: 68000 }], stock: 30 },
    { id: 106, name: "Peluche Buny Coneja", price: 42000, originalPrice: 50000, image: "/images/peluches/6.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 12 },
    { id: 107, name: "Peluche Max Perro", price: 42000, originalPrice: 50000, image: "/images/peluches/7.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 14 },
    { id: 108, name: "Peluche Kira Perra", price: 42000, originalPrice: 50000, image: "/images/peluches/8.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 16 },
    { id: 109, name: "Peluche Roco Toro", price: 42000, originalPrice: 50000, image: "/images/peluches/9.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 11 },
    { id: 110, name: "Peluche Mura Vaca", price: 42000, originalPrice: 50000, image: "/images/peluches/10.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 13 },
    { id: 111, name: "Peluche Nube Oveja", price: 42000, originalPrice: 50000, image: "/images/peluches/11.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 17 },
    { id: 112, name: "Peluche Kimi Oveja", price: 42000, originalPrice: 50000, image: "/images/peluches/12.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 12 },
    { id: 113, name: "Peluche Gino Jirafa", price: 42000, originalPrice: 50000, image: "/images/peluches/13.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 10 },
    { id: 114, name: "Peluche Jira Jirafa", price: 42000, originalPrice: 50000, image: "/images/peluches/14.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 8 },
    { id: 115, name: "Peluche Drako Dragon", price: 42000, originalPrice: 50000, image: "/images/peluches/15.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 14 },
    ...
    { id: 117, name: "Peluche Orejon Conejo Nino", price: 42000, originalPrice: 50000, image: "/images/peluches/17.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 20 },
    { id: 118, name: "Peluche Orejon Coneja Nina", price: 42000, originalPrice: 50000, image: "/images/peluches/18.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 16 },
    { id: 119, name: "Peluche Orejon Perro Nino", price: 42000, originalPrice: 50000, image: "/images/peluches/19.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 18 },
    { id: 120, name: "Peluche Orejon Perra Nina", price: 42000, originalPrice: 50000, image: "/images/peluches/20.webp", category: "peluches", variants: [{ label: "#2 - 40cm", price: 32000 }, { label: "#3 - 60cm", price: 42000 }, { label: "#4 - 100cm", price: 62000 }], stock: 11 },
    // Cojines
